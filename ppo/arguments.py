...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='eval interval, one eval per n updates (default: 50)')
    parser.add_argument(
        '--num-env-steps',
        type=int,
        default=10e6,
...
#        help='environment to train on (default: roboticgamedesign-v0)')
    ...
    ### roboLDA arguments begin: ###
    parser.add_argument("-tsk", "--num-tasks", default=1, type=int)
    parser.add_argument("-d", "--num-robos", default=None, type=int)
    parser.add_argument("-rt", "--num-robo-types", default=3, type=int)
    parser.add_argument("-t", "--num-organs", default=8, type=int)
    parser.add_argument("-w", "--num-voxels", default=5, type=int)
    parser.add_argument("-wd", "--num-voxels-per-doc", default=None, type=int) # robo_shape[0]*robo_shape[1]
    parser.add_argument("-n", "--num-train-steps", default=1000, type=int)
    parser.add_argument("-l", "--layer-sizes", default="100-100")
    parser.add_argument("-lr", "--learning-rate", default=0.01, type=float)
    parser.add_argument("-b", "--batch-size", default=32, type=int)
    parser.add_argument("--jit", action="store_true")
    ### roboLDA arguments stop ###
